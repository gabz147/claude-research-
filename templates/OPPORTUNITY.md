# OPPORTUNITY — <title>
**Date:** YYYY-MM-DD  **ID:** OPP-<n> / TASK-<n>  **Sector:** <sector>  **Confidence:** HIGH|MED|LOW
...
## AI applicability (does AI create measurable leverage? where? or N/A)
...
## Evidence (ranked sources, claims tagged FACT/LIKELY/SPECULATION/UNKNOWN)
