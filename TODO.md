...
| TASK-0017 | LOW | PENDING | **REFINED AGAIN (ADR-015):** the binding anti-pattern is **VISIBLE/NAMED MONEY POOLS, not compliance.** Leaving compliance (OPP-005 D&D) capped too → 5 consecutive caps (79/71/72/63/64) vs one 83. New doctrine: (1) named-incumbent vacuum check is FIRST + UNIVERSAL (both prevention AND recovery side); (2) de-prioritize any pain with a headline $-stat (it already recruited incumbents); (3) hunt fragmented/embarrassing/un-named-budget pain; target shape = contested-defense/record-reconstruction artifact with NO productized owner (OPP-001b) | — | 2026-06-16 | 2026-06-16 | Reviewer | HIGH | M |
