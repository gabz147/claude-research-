...
| TASK-0017 | LOW | PENDING | Discovery heuristic: bias net-new sector selection toward (a) just-landed forcing-functions (vacuum open) or (b) defensive sub-wedges incumbents can't serve (OPP-001b pattern) — 3 consecutive 70s show public forcing-functions get productized in 1-2yrs | — | 2026-06-16 | 2026-06-16 | Reviewer | MED | S |
