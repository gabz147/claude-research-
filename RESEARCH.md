...
## Open questions
- **(ADR-015) Where is the HIDDEN/fragmented pain?** Visible money pools (compliance regs AND big named cost-leaks like D&D) already have incumbents on both prevention & recovery. Hunt pain with no headline stat: fragmented across small budgets, embarrassing/unspoken, or not yet a named budget line. Leading seed: **construction delay / change-order claim-defense documentation** (services-only claims consultants; no productized owner — verify vacuum first).
